...
public:
  ...
  Camera(PerspectiveProjection projection,
      ...
      : Front(glm::vec3(0.0f, 0.0f, -1.0f)), MovementSpeed(SPEED),
        MouseSensitivity(SENSITIVITY), Zoom(ZOOM), projection(std::move(projection)) {
    Position = position;
    WorldUp = up;
    Yaw = yaw;
    Pitch = pitch;
  ...
  Camera(PerspectiveProjection projection,float posX, float posY, float posZ, float upX, float upY, float upZ,
