...
public:
  template <typename U = T, typename V = T> Range(T start, U end, V step = V{1});
...
namespace MakeRange {
template <typename T, typename U = T, typename V = T> Range<T> until(T start, U end, V step = T{1});

template <typename T, typename U = T, typename V = T> Range<T> to(T start, U end, V step = T{1});

template <typename T, typename U = T, typename V = T> Range<T> downTo(T start, U end, V step = T{1});

template <typename T, typename U = T, typename V = T> Range<T> downUntil(T start, U end, V step = T{1});
