...
using MouseDownFnc = std::function<void(EventInfo, MouseButton, SDL_Point position)>;
using MouseUpFnc = std::function<void(EventInfo, MouseButton, SDL_Point position)>;
...
enum class Type { Draw, VisibilityChanged, FocusChanged, EnabledChanged,
    MouseDown, MouseUp, MouseClicked, MouseDblClicked, MouseOver, MouseOut, MouseMove,
