...
template <typename T, unsigned int ChildCount>
Leaf<T, ChildCount>::Leaf(Leaf &&other) noexcept
...
template <typename T, unsigned int ChildCount> Node<T, ChildCount> *Leaf<T, ChildCount>::getParent() {
  return parent;
}
...
template <typename T, unsigned int ChildCount>
Node<T, ChildCount>::Node(const Node &other)
    : Leaf<T, ChildCount>(other) {
...
template <typename T, unsigned int ChildCount>
Node<T, ChildCount>::Node(Node &&other) noexcept
...
template <typename T, unsigned int ChildCount>
bool Node<T, ChildCount>::hasChildAtIndex(std::size_t index) {
  assert(index < ChildCount);
  return children[index] != nullptr;
}
template <typename T, unsigned int ChildCount>
typename Node<T, ChildCount>::Child &
Node<T, ChildCount>::setChildAtIndex(std::size_t index, NodeType nodeType) {
...
template <typename T, unsigned int ChildCount>
void Node<T, ChildCount>::setChildrenValues(const_reference_type value,
                                            NodeType nodeType) {
  if (nodeType == NodeType::Leaf) {
...
template <typename T, unsigned int ChildCount>
typename Node<T, ChildCount>::Child &
Node<T, ChildCount>::childAtIndex(std::size_t index) {
  assert(index < ChildCount);
  return *children[index];
}
template <typename T, unsigned int ChildCount>
