...
template <typename DataContainer, bool ReadOnly, typename Key> template <typename T, bool R, typename, typename... Keys>
...
template <typename DataContainer, bool ReadOnly, typename Key> template <bool R, typename>
...
template <typename DataContainer, bool ReadOnly, typename Key> template <typename T, typename... Keys>
bool Config<DataContainer, ReadOnly, Key>::contains(const T &value, const Keys &... keys) {
