...
public:
  ...
  std::enable_if_t<std::is_constructible_v<T, UIManager &, Args...>, std::shared_ptr<T>> createGUIObject(Args &&... args);

  void render(glm::mat4 projection = glm::mat4(1), glm::mat4 view = glm::mat4(1), glm::mat4 model = glm::mat4(1));
...
template <C_UIObject T, typename... Args> std::enable_if_t<std::is_constructible_v<T, UIManager &, Args...>, std::shared_ptr<T>>
