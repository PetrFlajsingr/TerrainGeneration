...
template <typename T>
constexpr bool is_keyboard_interactable =
    std::is_base_of_v<CustomKeyboardInteractable, T>;
template <typename T>
constexpr bool is_mouse_interactable =
    std::is_base_of_v<CustomMouseInteractable, T>;
