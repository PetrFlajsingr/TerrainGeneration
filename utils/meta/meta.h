...
template <typename T> concept SimpleInvocable = std::is_invocable_v<T>;
...
template <typename... T>
using highest_precision_t = std::conditional_t<
    is_one_of_v<long double, T...>, long double,
    std::conditional_t<
        is_one_of_v<double, T...>, double,
        std::conditional_t<is_one_of_v<float, T...>, float, void>>>;

template <typename... T>
using largest_integer_t = std::conditional_t<
                                ...
                                std::conditional_t<
                                    ...
                                    std::conditional_t<
                                        ...
                                        std::conditional_t<
                                            ...
                                            std::conditional_t<
                                                is_one_of_v<signed char, T...>,
                                                signed char,
                                                std::conditional_t<
                                                    is_one_of_v<unsigned char,
                                                                T...>,
                                                    unsigned char,
                                                    std::conditional_t<
                                                        is_one_of_v<char, T...>,
...
template <typename... T>
using largest_signed_integer_t = std::conditional_t<
    is_one_of_v<long long, T...>, long long,
    std::conditional_t<
        is_one_of_v<long, T...>, long,
        std::conditional_t<
                ...
                std::conditional_t<
                    ...
                    std::conditional_t<
                        ...
                        std::conditional_t<
                            is_one_of_v<wchar_t, T...>, wchar_t,
                            std::conditional_t<
                                is_one_of_v<signed char, T...>, signed char,
